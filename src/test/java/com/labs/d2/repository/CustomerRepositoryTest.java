...
class CustomerRepositoryTest {
    ...
    public void createNewCustomer_correctCase() {
        Customer c1 = new Customer("Sara Ahmed", CustomerStatus.Silver,2000);
    ...
    public void findByCustomerName_validName_correctCustomer() {
        ...
        assertEquals(CustomerStatus.Gold, customerOptional.get().getCustomerStatus());
    }

    @Test
    public void findByCustomerStatus_validStatus_correctCustomer() {
        List<Customer> customerList = customerRepository.findAllByCustomerStatus(CustomerStatus.Silver);
